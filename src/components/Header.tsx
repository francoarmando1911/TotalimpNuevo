            ...
            <div className="container-xl">
                <div className="row justify-content-center justify-content-md-between align-items-center">
                    <div className="col-8 col-md-3 d-flex align-items-center">
                        <a href="/">
                            <img className="img-fluid" src="/GotaLogo.png" alt="Logo de TOTALIMP" />
                        </a>
                    </div>
                    ...
                    <nav className="col-md-3 d-flex align-items-center justify-content-end">
                        <div className="carrito position-relative">
                            <button
                                ...
                                style={{
                                    backgroundColor: '#dc3545', border: 'none', borderRadius: '50%',
                            ...
                            {showCart && (
                                <div
                                    ...
                                    style={{
                                        ...
                                        width: '300px', maxHeight: isCartVisible ? '500px' : '0',
